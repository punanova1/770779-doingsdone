        ...
        <main class="content__main">
          ...
          <form class="form" action="" method="post">
            <div class="form__row">
              ...
              <input class="form__input <?= $registrationErrors["nameError"] ? "form__input--error" : ""?>" type="text" name="name" id="name" value="<?=strip_tags($userName)?>" placeholder="Введите имя">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?= $registrationErrors["emailError"] ? "form__input--error" : ""?>" type="text" name="email" id="email" value="<?=strip_tags($userEmail)?>" placeholder="Введите e-mail">

              <?= $registrationErrors["emailEmptyError"] ? "<p class=\"form__message\">Введите e-mail</p>" : "" ?>

              <?= $registrationErrors["emailValidityError"] ? "<p class=\"form__message\">Введен некорректный e-mail</p>" : "" ?>

              <?= $registrationErrors["emailTakenError"] ? "<p class=\"form__message\">Пользователь с таким e-mail уже существует</p>" : "" ?>
            </div>

            <div class="form__row">
              <label class="form__label" for="password">Пароль <sup>*</sup></label>

              <input class="form__input <?= $registrationErrors["passwordError"] ? "form__input--error" : ""?>" type="password" name="password" id="password" value="" placeholder="Введите пароль">

              <?= $registrationErrors["passwordError"] ? "<p class=\"form__message\">Введите пароль</p>" : "" ?>
            </div>



            <div class="form__row form__row--controls">
              <?= $registrationErrors["errors"] ? "<p class=\"error-message\">Пожалуйста, исправьте ошибки в форме</p>" : ""?>
